...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="bg-dark-800 rounded-xl shadow-lg p-6">
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-3xl font-bold ml-4">Edit Badge: {{ $badge->name }}</h1>
        </div>
        
        <form action="{{ route('badges.update', [$course->slug, $badge->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                <label class="block text-gray-300 mb-2">Current Badge Image</label>
                <div class="w-24 h-24 flex items-center justify-center bg-dark-700 rounded-lg p-2 mb-4">
                    <img 
                ...
                <label for="image" class="block text-gray-300 mb-2">Change Image (Optional)</label>
