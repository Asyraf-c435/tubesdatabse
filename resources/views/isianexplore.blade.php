        ...
        <body class="bg-white text-gray-700">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2 px-2">
                ...
                <div class="flex flex-col bg-white rounded overflow-hidden shadow-sm border border-gray-100">
                    <img alt="SAM website with red logo top left on light blue background" class="w-full object-cover max-h-[180px]" height="180" loading="lazy" src="https://storage.googleapis.com/a1aa/image/31836d98-5a4a-47a0-3bab-2b0f10184c22.jpg" width="400" />
                    <div class="flex items-center justify-between px-2 py-1 text-[11px] text-gray-600 border-t border-gray-200">
                        <div class="flex items-center gap-1 font-semibold text-[12px]">
                            <i class="fas fa-circle text-black text-[8px]">
                            </i>
                            <span>
                                The First The Last
                            </span>
                        ...
                        <div class="flex items-center gap-1 text-[9px] font-semibold">
                            <span class="border border-gray-300 rounded px-1 text-gray-500 select-none">
                                DEV
                            </span>
                            <span class="border border-red-300 text-red-600 rounded px-1 select-none">
                                SOTD
                            </span>
                        </div>
                    </div>
                ...
                <!-- Card 2 -->
                <div class="flex flex-col bg-white rounded overflow-hidden shadow-sm border border-gray-100">
                    <img alt="Times Two website with business tech customize sync UI screen" class="w-full object-cover max-h-[180px]" height="180" loading="lazy" src="https://storage.googleapis.com/a1aa/image/cd99be77-1c68-4e49-be0b-17a21d91481a.jpg" width="400" />
                    <div class="flex items-center justify-between px-2 py-1 text-[11px] text-gray-600 border-t border-gray-200">
                        <div class="flex items-center gap-1 font-semibold text-[12px]">
                            <i class="fas fa-circle text-black text-[8px]">
                                </i>
                ...
                <!-- Card 3 -->
                <div class="flex flex-col bg-white rounded overflow-hidden shadow-sm border border-gray-100">
                    <img alt="Jordan Delcros website with cards and keyboard on white background" class="w-full object-cover max-h-[180px]" height="180" loading="lazy" src="https://storage.googleapis.com/a1aa/image/de5ca4f2-e578-4628-972d-423abe6d62c8.jpg" width="400" />
                    <div class="flex items-center justify-between px-2 py-1 text-[11px] text-gray-600 border-t border-gray-200">
                        <div class="flex items-center gap-1 font-semibold text-[12px]">
                            <i class="fas fa-circle text-black text-[8px]">
                                </i>
                    ...
                    <!-- Card 4 -->
                    <div class="flex flex-col bg-white rounded overflow-hidden shadow-sm border border-gray-100">
                        <img alt="Dahil Heet website with cave and light beam green blue tones" class="w-full object-cover max-h-[180px]" height="180" loading="lazy" src="https://storage.googleapis.com/a1aa/image/c233fdc0-ef55-48c0-547c-2402c30e632d.jpg" width="400" />
                        <div class="flex items-center justify-between px-2 py-1 text-[11px] text-gray-600 border-t border-gray-200">
                            <div class="flex items-center gap-1 font-semibold text-[12px]">
                                <i class="fas fa-circle text-black text-[8px]">
                                    </i>
