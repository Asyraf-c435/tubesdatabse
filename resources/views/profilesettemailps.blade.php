<x-layout>
    ...
    <div class="bg-[#f8f8f8] text-[#1a1a1a] min-h-screen">
        <div class="max-w-[1100px] mx-auto px-4 py-6">
            ...
            <form class="flex flex-col sm:flex-row sm:items-start gap-4 mb-10" method="POST" action="{{ route('user.update2') }}">
                @csrf
                @method('PUT')
                ...
                <div class="flex flex-col sm:flex-col sm:gap-6 w-full sm:w-4/6">
                    <div class="mb-6 w-full">
                        <label class="text-[8px] text-[#999999] font-semibold mb-1 uppercase block" for="current-email">Current Password</label>
                        <input
                            id="current-password"
